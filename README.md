...
→ [View on Odoo Apps](https://apps.odoo.com/apps/modules/19.0/tt_purchase_vendor_bill_policy) *(pending publication)*
...
```bash
git clone -b 19.0 https://github.com/taghrasthink/odoo-purchase.git
```
